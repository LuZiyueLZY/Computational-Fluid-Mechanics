function [] = plot_results(stmfunc,vort,Nx,Ny,dx,dy,x,y,x2,y2,f,t)
...
% vortsouth=-2*stmfunc(2:end-1,2)/dl^2;
% vortnorth=-2*stmfunc(2:end-1,end-1)/dl^2-2*1/dl; % 1 in the last term means U_north=1
% vorteast =-2*stmfunc(end-1,2:end-1)/dl^2;
% vortwest =-2*stmfunc(2,2:end-1)/dl^2;
% 
% vort=[0         vortwest   0
